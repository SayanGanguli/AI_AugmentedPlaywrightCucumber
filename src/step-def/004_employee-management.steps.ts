...
Given('the employee user is on the employee management module page', async function (this: CustomWorld) {
...
When('the employee user performs the {string} action', async function (this: CustomWorld, action: string) {
...
Then('the employee result is visible', async function (this: CustomWorld) {
  await expect(this.page.locator('body')).toBeVisible();
});
