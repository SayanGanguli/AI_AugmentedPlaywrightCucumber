...
Given('the admin user is on the admin module page', async function (this: CustomWorld) {
...
When('the admin user performs the {string} action', async function (this: CustomWorld, action: string) {
...
Then('the admin result is visible', async function (this: CustomWorld) {
  await expect(this.page.locator('body')).toBeVisible();
});
